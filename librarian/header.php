                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="display_student_info.php"><i class="fa fa-home"></i> Students Info <span class="fa fa-chevron-down"></span></a>
                            ...
                            <li><a  href="return_book.php"><i class="fa fa-arrow-circle-left"></i>Book Return  <span
                                    class="fa fa-chevron-down"></span></a>
