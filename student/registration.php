...
$sql = "INSERT INTO student_registration(firstname,lastname,username,password,email,contact,sem,enrollment,status) VALUES ('$firstname','$lastname','$username','$password','$email','$contact','$sem','$enrollment','no' )";
